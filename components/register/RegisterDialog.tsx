...
//     useState<RegisterAppliesTo>("ENTIRE_ORDER");
...
//         code: register.code || "",
//         type: register.type,
//         value: parseFloat(register.value.toString()),
//         minPurchaseAmount: register.minPurchaseAmount
//           ? parseFloat(register.minPurchaseAmount.toString())
//           : 0,
//         appliesTo: register.appliesTo,
//         productIds:
//           (register as any).products?.map((product: Partial<Product>) => product.id) ||
//           [],
//         categoryIds: register.categoryIds?.split(",") || [],
//         buyXQuantity: register.buyXQuantity ?? undefined,
//         getYQuantity: register.getYQuantity ?? undefined,
//         startDate: new Date(register.startDate),
//         endDate: register.endDate ? new Date(register.endDate) : undefined,
//         maxUses: register.maxUses ?? undefined,
//         isActive: register.isActive,
//       });
//       setSelectedAppliesTo(register.appliesTo);
...
//     setSelectedAppliesTo(value as RegisterAppliesTo);
//     form.setValue("appliesTo", value as RegisterAppliesTo);
//   };

//   const handleTypeChange = (value: string) => {
//     form.setValue("type", value as RegisterType);
...
//                           Make this register active and available for use
//                         </p>
//                       </div>
//                       <FormControl>
//                         <Switch
