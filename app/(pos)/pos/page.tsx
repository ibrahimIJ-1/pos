...
function POS() {
  return (
    <div className="px-10 py-4 dark:pt-0 neon-card h-screen dark:bg-black  dark:border-b-1 dark:border-r-1 dark:border-l-1 rounded-b-md dark:shadow-md dark:shadow-violet-700 dark:border-violet-800">
