...
import { saveSettings, getGeneralSettings, getStoreSettings, getNotificationSettings } from "@/lib/settings-service";
...
export default function SettingsPage() {
  ...
  const handleSaveSettings = async () => {
    try {
      ...
      const settingsPayload = {
        ...
        emailNotifications: { value: notificationSettings.emailNotifications, category: "notifications" },
        inventoryAlerts: { value: notificationSettings.inventoryAlerts, category: "notifications" },
        salesReports: { value: notificationSettings.salesReports, category: "notifications" }
      };
  ...
  const handleStoreChange = (key: keyof typeof storeSettings, value: string) => {
    setStoreSettings(prev => ({ ...prev, [key]: value }));
  };
  
  // Handle notification settings changes
  const handleNotificationChange = (key: keyof typeof notificationSettings, value: string) => {
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => handleGeneralChange("darkMode", checked.toString())}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select 
                  ...
                  onValueChange={(value) => handleStoreChange("currency", value)}
                >
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => handleStoreChange("taxEnabled", checked.toString())}
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => handleNotificationChange("emailNotifications", checked.toString())}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => handleNotificationChange("inventoryAlerts", checked.toString())}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => handleNotificationChange("salesReports", checked.toString())}
                />
              </div>
            </CardContent>
          </Card>
